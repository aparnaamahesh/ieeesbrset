...
export const societies = {
  SB: [
    ...
    { name: "Krishnapriya M", position: "IEEE Student Branch Vice Chair", img: "Krishnapriya - vice chair.jpg", link: "krishnapriya" },
    { name: "Kriselle Thomas", position: "Secretary", img: "public/Execom 2026/Kriselle Thomas - secretary.jpg", link: "kriselle" },
    { name: "Michal Mathew", position: "Treasurer", img: "Treasurer.jpg", link: "michal" },
    { name: "Adriel Bobby", position: "Technical Coordinator", img: "Adriel Bobby - Technical Coordinator.JPG", link: "adriel" },
    { name: "Justin Joven Malakkaran", position: "Electronic Communications Coordinator", img: "electronic com coordinator.jpg", link: "justin" },
    { name: "Aleena Anie Shibu", position: "Membership Development Coordinator", img: "Aleena Anie Shibu - mdc.jpg", link: "aleena" },
    { name: "Athulya Aravindhakshan", position: "Membership Development Coordinator", img: "Athulya Aravindhakshan - mdc.jpg", link: "athulya" },
    { name: "Emmanuel Babu", position: "Membership Development Coordinator", img: "Emmanuel Babu- mdc.jpg", link: "emmanuel" },
    { name: "Sharika B Menon", position: "Membership Development Coordinator", img: "Sharika B Menon - mdc.jpg", link: "Sharika" },
    { name: "Aparna Mahesh", position: "Webmaster", img: "Aparna Mahesh - webmaster.jpg", link: "aparna" },
    { name: "Anandu D", position: "Webmaster", img: "Anandu D- webmaster.jpg", link: "anandu" },
    { name: "Benita George", position: "LINK Representative", img: "Benita George- link rep.jpeg", link: "benita" },
    { name: "Nikhil S Nair", position: "Design Lead", img: "Nikhil S Nair - design lead.jpg", link: "nikhil" },
    { name: "Chris Laynad", position: "Design Lead", img: "Chris Laynad - DEsign Co Lead.jpg", link: "chris" },
    { name: "Gautham K G", position: "Media Lead", img: "Gautham K G- media lead.jpg", link: "gautham" },
    { name: "Adithyan P", position: "Media Co-Lead", img: "media co lead.jpg", link: "adithyan" },
  ],
  CS: [
